...
public class ProductionSettings {
    public ProductionSettings(@Value("${app.auth.admin-code}") String admin,@Value("${app.auth.editor-code}") String editor,
        ...
        for(String value:java.util.List.of(password))
        ...
        if(admin.isBlank() || editor.isBlank() || admin.equals(editor))throw new IllegalStateException("Admin and editor codes must differ");
    }
}
