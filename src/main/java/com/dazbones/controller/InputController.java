...
public class InputController {
 ...
 @PostMapping("/api/input/fee") @ResponseBody public Map<String,Object> fee(@RequestParam Long playerId,@RequestParam int year,@RequestParam boolean paid,@RequestParam(required=false) Integer amount,@RequestParam(defaultValue="") String comment,@RequestParam Long version,HttpSession s){return input.fee(user(s),playerId,year,paid,comment,version,amount);}
